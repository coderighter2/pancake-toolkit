...
var Icon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 400 400" }, props),
        React__default['default'].createElement("g", { id: "svgg" },
            ...
            React__default['default'].createElement("path", { id: "path5", d: "", stroke: "none", fill: "#64746c" }),
            React__default['default'].createElement("path", { id: "path6", d: "M194.575 263.962 L 193.836 264.780 194.654 264.041 C 195.104 263.635,195.472 263.267,195.472 263.223 C 195.472 263.029,195.264 263.200,194.575 263.962 ", stroke: "none", fill: "#94aeac" }),
            React__default['default'].createElement("path", { id: "path7", d: "M116.793 264.528 C 116.796 265.082,116.847 265.279,116.907 264.966 C 116.968 264.653,116.965 264.200,116.902 263.959 C 116.839 263.719,116.790 263.975,116.793 264.528 M116.788 271.447 C 116.788 271.931,116.840 272.129,116.903 271.887 C 116.966 271.645,116.966 271.248,116.903 271.006 C 116.840 270.764,116.788 270.962,116.788 271.447 ", stroke: "none", fill: "#90aca4" }),
